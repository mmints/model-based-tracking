...
GLuint CVK::ShaderSet::getProgramID() const
{
	return( m_ProgramID);
}

void CVK::ShaderSet::useProgram() const
{
...
CVK::ShaderSet::~ShaderSet()
{
	if (m_ProgramID != INVALID_GL_VALUE) glDeleteProgram( m_ProgramID);
}

void CVK::ShaderSet::setTextureInput(unsigned int num, GLuint texture)
{
...
void CVK::ShaderSet::setValue(const char* variableName, float value) const
{
...
void CVK::ShaderSet::loadShaderSource(GLint shaderID, const char* fileName) const
{
