...
GLFWwindow* window;
mt::ParticleGenerator* particleGenerator;
...
int main()
{
    ...
    window = glfwCreateWindow(WIDTH, HEIGHT, "[TEST] Particle Update", nullptr, nullptr);
    ...
    particleGenerator = new mt::ParticleGenerator(RESOURCES_PATH "/rubiks_cube/rubiks_cube.obj", 256, WIDTH, HEIGHT);
